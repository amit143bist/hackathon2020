...
@JsonPropertyOrder({ "documentId", "pageNumber", "recipientId", "xPosition", "yPosition", "anchorString",
		"anchorXOffset", "anchorYOffset", "anchorHorizontalAlignment", "anchorIgnoreIfNotPresent" })
